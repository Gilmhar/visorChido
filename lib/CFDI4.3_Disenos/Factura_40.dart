// ignore_for_file: file_names, must_be_immutable, non_constant_identifier_names, unused_element, unused_local_variable
...
class Factura40 extends StatefulWidget {
  String data;
  Factura40({Key? key, required this.data}) : super(key: key);

  @override
  State<Factura40> createState() => _Factura40State();
}

class _Factura40State extends State<Factura40> {

  //Aqui se crea la pagina del XML estructurado, se declara todas sus funciones y se separa por datos
          ...
          iemisor
              ? Column(
                  children: [
                    ...
                    dato.domiciliocalleEmisor + dato.domiciliocpEmisor == ''
                        ? Container()
                        : heads(context, 'DomicilioFiscal', 0, 15),
                    name('calle', dato.domiciliocalleEmisor, context),
                    name('noExterior', dato.domicilionoExteriorEmisor, context),
                    name('colonia', dato.domiciliocoloniaEmisor, context),
                    name('localidad', dato.domiciliolocalidadEmisor, context),
                    name('referencia', dato.domicilioreferenciaEmisor, context),
                    name('municipio', dato.domiciliomunicipioEmisor, context),
                    name('estado', dato.domicilioestadoEmisor, context),
                    name('pais', dato.domiciliopaisEmisor, context),
                    name('codigoPosta', dato.domiciliocpEmisor, context),
                  ],
                )
              : const Divider(
                  color: Colors.transparent,
          ...
          ireceptor
              ? Column(
                  children: [
                    ...
                    dato.domiciliocalleReceptor + dato.domiciliocpReceptor == ''
                        ? Container()
                        : heads(context, 'Domicilio', 0, 15),
                    name('calle', dato.domiciliocalleReceptor, context),
                    name('noExterior', dato.domicilionoExteriorReceptor,
                        context),
                    name('colonia', dato.domiciliocoloniaReceptor, context),
                    name('localidad', dato.domiciliolocalidadReceptor, context),
                    name('referencia', dato.domicilioreferenciaReceptor,
                        context),
                    name('municipio', dato.domiciliomunicipioReceptor, context),
                    name('estado', dato.domicilioestadoReceptor, context),
                    name('pais', dato.domiciliopaisReceptor, context),
                    name('codigoPosta', dato.domiciliocpReceptor, context),
                  ],
                )
              : const Divider(
                  color: Colors.transparent,
